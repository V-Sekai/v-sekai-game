@tool
class_name SarDataStorageUnitUtilities

## This class contains helper functions designed for dealing with representing
## different types of data storage units.
