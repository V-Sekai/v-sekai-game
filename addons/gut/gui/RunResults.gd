...
func _test_running_setup():
	...
	set_font(_gut_config.options.panel_options.font_name, _gut_config.options.panel_options.font_size)
...
func _add_script_tree_item(script_path, script_json):
	...
	var meta = {"type": "script", "path": path_info.path, "inner_class": path_info.inner_class, "json": script_json}
