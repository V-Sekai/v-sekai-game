@icon("res://addons/gd_shell/icon.png")
...
const COMMAND_DIR_PATH: String = "res://addons/gd_shell/commands/"

const UI_HANDLER_PATH: String = "res://addons/gd_shell/ui/default_ui/default_ui.tscn"
...
static func get_gdshell_version() -> String:
	...
	if config.load("res://addons/gd_shell/plugin.cfg"):
		return "Unknown"
