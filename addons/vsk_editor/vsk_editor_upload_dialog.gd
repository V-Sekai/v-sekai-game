...
# vsk_editor_upload_dialog.gd
# SPDX-License-Identifier: MIT

@tool
extends AcceptDialog
class_name VSKEditorUploadDialog
...
const LOGIN_REQUIRED_STRING: String = "Please log in to upload content"
const INVALID_PERMISSIONS: String = "Your account does not currently have permission to upload this type of content"

const TITLE_STRING: String = "Upload"
const WINDOW_RESOLUTION: Vector2 = Vector2(1280, 720)

const upload_panel_content_const = preload("vsk_editor_upload_panel_contents.tscn")
