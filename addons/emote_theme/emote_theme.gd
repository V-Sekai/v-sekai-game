...
func generate_emote_theme(p_theme_class, p_scale: float) -> Theme:
    ...
    style_tree_btn.set_resource_name("StyleTreeButton")
    ...
    style_tree_focus.set_resource_name("StyleTreeFocus")
    ...
    style_tree_selected.set_resource_name("StyleTreeSelected")
    theme.set_stylebox("selected", "Tree", style_tree_selected)

    var style_tree_cursor = style_default.duplicate()
    style_tree_cursor.set_resource_name("StyleTreeCursor")
    ...
    style_itemlist_bg.set_resource_name("StyleItemlistBG")
    ...
    style_itemlist_cursor.set_resource_name("StyleItemlistCursor")
    ...
    style_content_panel.set_resource_name("StyleContentPanel")
    ...
    style_content_panel_vp.set_resource_name("StyleContentPanelVP")
